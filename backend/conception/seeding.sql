...
('Geneviève', 'genevieve@example.com', '!12345'),
('RatBiblio', 'ratbiblio@example.com', '%12345'),
('BookAddict', 'bookaddict@example.com', '$12345'),
('JMlire', 'jmlire@example.com', '§12345'),
...
(10, '9782267054859', 'TRUE', 'TRUE', '', 'un classique de chez classique dans le genre héroïc fantasy / SF....c''est plus qu''une histoire que nous peint Tolkien, c''est une fresque avec tout ce que cela attend '),
(1, '9782267054859', 'TRUE', 'FALSE', '', 'Lu et relu un certain nombre de fois. J''aime entrer dans ce monde de créatures, magique, monstrueuses, où le mal et le bien mène un combat permanent. ');
